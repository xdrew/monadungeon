...
export const getTileImageWithRotation = (orientationChar, isRoom = false) => {
  ...
  if (config) {
    ...
    return {
      image: `/assets/tiles/${prefix}-${config.base}-e.webp`,
...
export const preloadTileImages = async () => {
  ...
  const tilePaths = [
    '/assets/tiles/c-1111-v3.webp', // Corridor crossroads
    '/assets/tiles/c-1110-v3.webp', // Corridor T-junction
    '/assets/tiles/c-1100-v3.webp', // Corridor corner
    '/assets/tiles/c-1010-v3.webp', // Corridor straight vertical
    '/assets/tiles/r-1111-v3.webp', // Room crossroads
    '/assets/tiles/r-1110-v3.webp', // Room T-junction
    '/assets/tiles/r-1100-v3.webp', // Room corner
    '/assets/tiles/r-1010-v3.webp', // Room straight vertical
  ];
