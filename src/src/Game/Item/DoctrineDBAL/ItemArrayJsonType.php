...
final class ItemArrayJsonType extends Type
{
    ...
    public function convertToPHPValue(mixed $value, AbstractPlatform $platform): ?array
    {
        ...
        if (!\is_array($value)) {
            throw ConversionException::conversionFailedInvalidType($value, $this->getName(), ['null', sprintf('array<array|%s>', Item::class)]);
        }
    ...
    public function convertToDatabaseValue(mixed $value, AbstractPlatform $platform): mixed
    {
        ...
        if (!\is_array($value)) {
            throw ConversionException::conversionFailedInvalidType($value, $this->getName(), ['null', sprintf('array<%s>', Item::class)]);
        }
        ...
        /* @psalm-check-type-exact $converted = \array<array{name: string, type: string, guardHP: int, treasureValue: int, guardDefeated: bool, itemId: string, endsGame: bool}> */
